...
export default function BootLog({ progress, title = "Booting Akash’s Playground…", onComplete }: { progress: number; title?: string; onComplete?: () => void }) {
  const lines = useMemo(
    () => [
      "AKASH BIOS v2.0   © 2025 Akash Kumar Sharma",
